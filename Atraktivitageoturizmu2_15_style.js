...
var style_Atraktivitageoturizmu2_15 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (size == 1) {
        ...
        if (feature.get("Atraktivita geoturizmu") !== null) {
            labelText = String(feature.get("Atraktivita geoturizmu"));
        }
